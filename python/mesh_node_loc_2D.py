...
lib.MeshTree2D_create.restype = ctypes.c_void_p
lib.MeshTree2D_create.argtypes = [
...
lib.MeshTree2D_query.restype = None
lib.MeshTree2D_query.argtypes = [
    ctypes.c_void_p,
    np.ctypeslib.ndpointer(dtype=np.float64, ndim=2, flags=("C", "ALIGNED")),
...
lib.MeshTree2D_destroy.restype = None
lib.MeshTree2D_destroy.argtypes = [ctypes.c_void_p]
...
class MeshTree2D:
    ...
    def __init__(self, nodes, tri):
        ...
        t0 = perf_counter()
        self.tree = lib.MeshTree2D_create(
            nodes,
            tri,
            nodes.shape[0],
            tri.shape[0]
    ...
    def __del__(self):
        ...
        lib.MeshTree2D_destroy(self.tree)
        return
